...
simulation.callbacks[:progress1] = Callback(SimpleTimeMessenger())
simulation.callbacks[:progress2] = Callback(TimeMessenger())
simulation.callbacks[:progress] = Callback(StopwatchMessenger())
