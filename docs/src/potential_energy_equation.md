...
potential energy (per unit mass). Its split into a background and an available part lives in
[the available potential energy equation](available_potential_energy_equation.md). In a
Boussinesq fluid, the specific potential energy is defined as
